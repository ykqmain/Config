...
![](https://github.com/ykqmain/Config/blob/master/Archive/Pix/Desktop.png)
...
2. Developer Tools
    ...
    * [**Sourcetree**](https://sourcetreeapp.com) ([Git](https://git-scm.com) GUI) ([_postgresql_](https://www.postgresql.org)、[Postgres.app](https://postgresapp.com)、[DBeaver](https://dbeaver.io)、[QGIS](https://www.qgis.org)、[Wireshark](https://www.wireshark.org))
...
4. 工具
    ...
    * [Amphetamine](https://apps.apple.com/us/app/amphetamine/id937984704?mt=12) (keep-awake) [App Store] ([_Keep Screen On_](https://www.keepscreenon.com)、[_LocalSend_](https://web.localsend.org))
