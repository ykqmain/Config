...
plugins=(zsh-syntax-highlighting zsh-autosuggestions zsh-completions history-substring-search history encode64 extract z macos git python pip sublime web-search)
