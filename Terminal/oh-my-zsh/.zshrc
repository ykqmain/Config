...
plugins=(zsh-syntax-highlighting zsh-completions zsh-autosuggestions history history-substring-search extract encode64 z macos git python pip sublime brew tldr httpie web-search)
