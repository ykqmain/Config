...
plugins=(zsh-syntax-highlighting zsh-autosuggestions zsh-completions history-substring-search history macos encode64 extract z git brew python pip sublime web-search)
