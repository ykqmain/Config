...
plugins=(zsh-syntax-highlighting zsh-autosuggestions zsh-completions history-substring-search history macos encode64 extract z git brew httpie python pip pyenv sublime web-search)
